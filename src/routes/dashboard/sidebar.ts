...
${navLinks}
    ...
    <div class="sidebar-footer" style="display:flex;flex-direction:column;gap:6px">
      ${dmToggle}
      <button class="logout-btn" onclick="logoutDashboard()" title="Lock the dashboard">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
        <span>Lock</span>
      </button>
      <button class="logout-btn restart-btn" onclick="restartServer()" title="Restart the server (applies PORT/HOST changes)">
